...
class ShoppingEntry(models.Model):
    ...
    recipes = models.ForeignKey(Recipe, on_delete=models.RESTRICT, null=True, blank=True)
    ...
    def __str__(self):
        return "ShoppingEntry: {} {} {}".format(self.name, self.recipes, self.food)
...
class ShoppingList(models.Model):
    ...
    def __str__(self):
        return "Shopping: {} {}".format(self.entries, self.user)